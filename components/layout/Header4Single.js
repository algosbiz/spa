                    ...
                    <div class="header__main">
                        ...
                        <div class="main-menu main-menu-light">
                            ...
                            <div class="menu-btns light">
                                <button class="search-trigger d-none d-lg-block" onClick={handleToggleSearch}><i class="fa-light fa-magnifying-glass"></i></button>
                                <button onClick={handleToggleSidebar} class="menubars" type="button" data-bs-toggle="offcanvas" data-bs-target="#menubar">
