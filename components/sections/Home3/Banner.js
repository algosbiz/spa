...
export default function Home3_Banner() {
    return (
        <>
        <section className="banner-three-area section__decoration-top section__decoration-bottom">
            ...
            <div className="container">
                <div className="banner-three__content">
                    ...
                    <Link href="https://wa.me/6287863175144" target="_blank" rel="noopener noreferrer" className="btn-two-light wow fadeInDown mt-50" data-wow-delay="1s">Book Now
