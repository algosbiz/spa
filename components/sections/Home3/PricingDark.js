                ...
                <div className="outer-box mb-50">
                    <div className="row g-4">
                        <div className="col-lg-8 col-xl-9 image-column">
                            <div className="image-box"> <img loading="lazy" decoding="async" src="/images/pricing/pricing-three-image1.jpg" alt="image"/>
                            </div>
                        </div>
                ...
                <div className="outer-box">
                    <div className="row g-4">
                        ...
                        <div className="col-lg-8 col-xl-9 image-column order-1 order-lg-2">
                            <div className="image-box"><img loading="lazy" decoding="async" src="/images/pricing/pricing-three-image2.jpg" alt="image"/></div>
                        </div>
                    </div>
                </div>
            </div>
