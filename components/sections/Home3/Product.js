...
export default function Home3_Product() {
    const swiperOptions = {
                    ...
                    <div className="swiper-wrapper">
                        <SwiperSlide className="swiper-slide product-block-three">
                            <div className="inner-box">
                                <div className="image">
                                    <Link href="/shop-products"><img loading="lazy" decoding="async" src="/images/product/product-image1.png"
                                            alt="image"/></Link>
                                    <div className="info">
                                        <Link href="#0">
                                ...
                                <div className="content">
                                    ...
                                    <h3 className="title"><Link href="/shop-products">Glow Facial Cream</Link></h3>
                                </div>
                            </div>
                        </SwiperSlide>
                        <SwiperSlide className="swiper-slide product-block-three">
                            <div className="inner-box">
                                <div className="image">
                                    <Link href="/shop-products"><img loading="lazy" decoding="async" src="/images/product/product-image2.png"
                                            alt="image"/></Link>
                                    <div className="info">
                                        <Link href="#0">
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                        ...
                        <SwiperSlide className="swiper-slide product-block-three">
                            <div className="inner-box">
                                <div className="image">
                                    <Link href="/shop-products"><img loading="lazy" decoding="async" src="/images/product/product-image3.png"
                                            alt="image"/></Link>
                                    <div className="info">
                                        <Link href="#0">
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                        ...
                        <SwiperSlide className="swiper-slide product-block-three">
                            <div className="inner-box">
                                <div className="image">
                                    <Link href="/shop-products"><img loading="lazy" decoding="async" src="/images/product/product-image4.png"
                                            alt="image"/></Link>
                                    <div className="info">
                                        <Link href="#0">
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                        ...
                        <SwiperSlide className="swiper-slide product-block-three">
                            <div className="inner-box">
                                <div className="image">
                                    <Link href="/shop-products"><img loading="lazy" decoding="async" src="/images/product/product-image5.png"
                                            alt="image"/></Link>
                                    <div className="info">
                                        <Link href="#0">
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
