...
export default function Home3_News() {
	const swiperOptions = {
    ...
    return (
        ...
        <section id="news" className="blog-section pt-130 pb-130">
            <div className="shape">
                <img loading="lazy" decoding="async" className="animation__sunMove" src="/images/shape/blog-shape.png" alt="shape"/>
            </div>
                    ...
                    <div className="swiper-wrapper">
                        <SwiperSlide className="swiper-slide blog-block">
                            <div className="inner-box">
                                <div className="image-box">
                                    <div className="image">
                                        <img loading="lazy" decoding="async" src="/images/blog/blog-image4.jpg" alt="imag"/>
                                    </div>
                                </div>
                                <div className="content-box">
                                    <h6 className="info"><span>Admin</span><span className="dot">Body, Treatment</span></h6>
                                    <h4 className="title"><Link href="/news-details">Spring is in the Air and So Our These
                                            Amazing Spa Offers</Link></h4>
                                    <Link className="readMore-btn" href="/news-details">Read More</Link>
                                </div>
                            </div>
                        </SwiperSlide>
                        ...
                        <SwiperSlide className="swiper-slide blog-block">
                            <div className="inner-box">
                                ...
                                <div className="content-box">
                                    <h6 className="info"><span>Admin</span><span className="dot">Body, Treatment</span></h6>
                                    <h4 className="title"><Link href="/news-details">We giving Amazing special spa and
                        ...
                        <SwiperSlide className="swiper-slide blog-block">
                            <div className="inner-box">
                                <div className="image-box">
                                    <div className="image">
                                        <img loading="lazy" decoding="async" src="/images/blog/blog-image6.jpg" alt="imag"/>
                                    </div>
                                </div>
                                <div className="content-box">
                                    <h6 className="info"><span>Admin</span><span className="dot">Body, Treatment</span></h6>
                                    <h4 className="title"><Link href="/news-details">Looks reasonable. The generate is
                        ...
                        <SwiperSlide className="swiper-slide blog-block">
                            <div className="inner-box">
                                <div className="image-box">
                                    <div className="image">
                                        <img loading="lazy" decoding="async" src="/images/blog/blog-image5.jpg" alt="imag"/>
                                    </div>
                                </div>
                                <div className="content-box">
                                    <h6 className="info"><span>Admin</span><span className="dot">Body, Treatment</span></h6>
