...
export default function Home6_Portfolio() {
    const swiperOptions = {
                    ...
                    <div className="swiper-wrapper">
                        <SwiperSlide className="swiper-slide gallery-block-two">
                            <div className="inner-box">
                                <img loading="lazy" decoding="async" src="/images/gellery/gallery-two-image1.jpg" alt="image"/>
                        ...
                        <SwiperSlide className="swiper-slide gallery-block-two">
                            <div className="inner-box">
                                <img loading="lazy" decoding="async" src="/images/gellery/gallery-two-image2.jpg" alt="image"/>
                                <div className="content">
                        ...
                        <SwiperSlide className="swiper-slide gallery-block-two">
                            <div className="inner-box">
                                <img loading="lazy" decoding="async" src="/images/gellery/gallery-two-image3.jpg" alt="image"/>
                                <div className="content">
                        ...
                        <SwiperSlide className="swiper-slide gallery-block-two">
                            <div className="inner-box">
                                <img loading="lazy" decoding="async" src="/images/gellery/gallery-two-image4.jpg" alt="image"/>
                                <div className="content">
                                    <h5 className="sub-title">Hot</h5>
