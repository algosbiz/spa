...
export default function Home6_News() {
    return (
        <>
        <section id="news" className="blog-section-two pt-130 pb-130">
                ...
                <div className="row g-4">
                    <div className="col-md-6 col-xl-4 blog-block-two wow fadeInLeft" data-wow-delay="00ms"
                        ...
                        <div className="inner-box">
                            <div className="image">
                                <img loading="lazy" decoding="async" src="/images/blog/blog-two-image1.jpg" alt="imag"/>
                            </div>
                    ...
                    <div className="col-md-6 col-xl-4 blog-block-two wow fadeInLeft" data-wow-delay="200ms"
                        ...
                        <div className="inner-box">
                            <div className="image">
                                <img loading="lazy" decoding="async" src="/images/blog/blog-two-image2.jpg" alt="imag"/>
                            </div>
                            <div className="content">
                                <h6 className="info"><span>Admin</span><span className="dot">Body, Treatment</span></h6>
                                <h4 className="title"><Link href="/news-details">We giving Amazing special spa and message
                    ...
                    <div className="col-md-6 col-xl-4 blog-block-two wow fadeInLeft" data-wow-delay="400ms"
                        ...
                        <div className="inner-box">
                            <div className="image">
                                <img loading="lazy" decoding="async" src="/images/blog/blog-two-image3.jpg" alt="imag"/>
                            </div>
                            <div className="content">
                                <h6 className="info"><span>Admin</span><span className="dot">Body, Treatment</span></h6>
