...
// Plain text bridge shown between the à-la-carte PackageSection and the
// curated PackagePricing tables. Same spirit as the PricingCta banner in
// Home5/PackagePricing.js, but without the background image, box, or brush frame.
const lotusIcon = (
...
export default function Home1_PackageIntroText({
    ...
    <section className="package-intro-text" style={{ padding: '70px 0' }}>
      <div className="container">
        <div style={{ maxWidth: '820px', margin: '0 auto', textAlign: 'center' }}>
          ...
          {/* Lotus divider — matches the site's signature ornament */}
          <div
          ...
          >
            <span style={{ width: '60px', height: '1px', background: 'rgba(167, 134, 39, 0.45)' }}></span>
            {lotusIcon}
            <span style={{ width: '60px', height: '1px', background: 'rgba(167, 134, 39, 0.45)' }}></span>
          </div>
