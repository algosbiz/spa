...
export default function Home1_About({
    ...
    // undefined falls back to the treatment leaf as before; an explicit null
    // means the caller wants no left ornament at all.
    const showLeftShape = leftShapeSrc !== null
                    ...
                    <div className="row g-4">
                        <div className="col-lg-7 content-column">
                            <div className="inner-column">
                                ...
                                <Link href={buttonLink} className="btn-one mt-30 wow fadeInDown" data-wow-delay="400ms"
                                    data-wow-duration="1500ms">{buttonText}
