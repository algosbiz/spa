...
export default function Home1_Testimonial() {

    return (
        <>
        <section className="testimonial-section pt-130 pb-130">
            <div className="shape">
                <img loading="lazy" decoding="async" className="animation__arryUpDown" src="/images/shape/testimonial-shape.png" alt="image"/>
            </div>
                    ...
                    <div className="swiper-wrapper">
                        <SwiperSlide className="swiper-slide testimonial-block">
                            <div className="inner-box">
                                <div className="image-box">
                                    <div className="image">
                                        <img loading="lazy" decoding="async" src="/images/testimonial/testimonial-image1.png" alt="image"/>
                                    </div>
                                </div>
                        ...
                        <SwiperSlide className="swiper-slide testimonial-block">
                            <div className="inner-box">
                                <div className="image-box">
                                    <div className="image">
                                        <img loading="lazy" decoding="async" src="/images/testimonial/testimonial-image2.png" alt="image"/>
                                    </div>
                                </div>
                                <div className="content-box">
                                    <div className="head">
                        ...
                        <SwiperSlide className="swiper-slide testimonial-block">
                            <div className="inner-box">
                                <div className="image-box">
                                    <div className="image">
                                        <img loading="lazy" decoding="async" src="/images/testimonial/testimonial-image3.png" alt="image"/>
                                    </div>
                                </div>
                                <div className="content-box">
                                    <div className="head">
