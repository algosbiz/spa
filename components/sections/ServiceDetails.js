            ...
            <div className="container">
                <div className="row">
					...
					<div className="col-xl-8 col-lg-8">
						...
						<img loading="lazy" decoding="async" src="/images/resource/service-details.jpg" alt="Image"/>
						...
						<div className="content mt-40">
							...
							<div className="row clearfix">
								...
								<img loading="lazy" decoding="async" className="mb-3 w-100" src="/images/resource/service-d1.jpg" alt="images" />
								...
								<div className="col-lg-6 col-md-6 col-sm-12 column">
								<img loading="lazy" decoding="async" className="mb-3 w-100" src="/images/resource/service-d2.jpg" alt="images" />
								<p>Lorem ipsum dolor sit amet consec adipis elit Dolor repellat pariatur temporibus doloribus hic conse quatur copy typing refreshing</p>
								</div>
							</div>
							</div>
