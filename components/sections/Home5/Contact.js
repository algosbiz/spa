...
export default function Home5_Contact() {
    ...
    const handleSubmit = (e) => {
        ...
        // Submit logic here (e.g., API or EmailJS)
    };


    return (
        <>
            <section id="contact" className="contact-section-two section__decoration-top section__decoration-bottom pt-100 pb-100" style={{ backgroundImage: `url(/images/bg/contact-five-bg.jpg)` }}>
                             ...
                             <form
                                ...
                                <div className="row g-4">
                                    ...
                                    >
                                        ...
                                        <option value="candle-massage">Candle Massage</option>
                                ...
                                <textarea
                                    ...
                                    onChange={handleChange}
                                ></textarea>
                                <button type="submit" className="btn-two mt-35">
                                    Book An Appointment
