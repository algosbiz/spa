                    ...
                    <div className="swiper-wrapper">
                        <SwiperSlide className="swiper-slide team-block">
                            <div className="inner-box">
                                <div className="image">
                                    <img loading="lazy" decoding="async" src="/images/team/team-image1.jpg" alt="image"/>
                                </div>
                                ...
                                <div className="content">
                                    <div className="shape">
                                        <img loading="lazy" decoding="async" src="/images/team/shape.png" alt="image"/>
                                    </div>
                        ...
                        <SwiperSlide className="swiper-slide team-block">
                            <div className="inner-box">
                                <div className="image">
                                    <img loading="lazy" decoding="async" src="/images/team/team-image2.jpg" alt="image"/>
                                </div>
                                <ul className="socials">
                                    <li>
                                        <Link href="#0">
                        ...
                        <SwiperSlide className="swiper-slide team-block">
                            <div className="inner-box">
                                <div className="image">
                                    <img loading="lazy" decoding="async" src="/images/team/team-image3.jpg" alt="image"/>
                                </div>
                                <ul className="socials">
                                    <li>
                                        <Link href="#0">
                        ...
                        <SwiperSlide className="swiper-slide team-block">
                            <div className="inner-box">
                                <div className="image">
                                    <img loading="lazy" decoding="async" src="/images/team/team-image4.jpg" alt="image"/>
                                </div>
                                <ul className="socials">
                                    <li>
                                        <Link href="#0">
