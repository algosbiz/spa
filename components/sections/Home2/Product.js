...
export default function Home2_Product() {
    const swiperOptions = {
                        ...
                        <Swiper {...swiperOptions} className="swiper product-slider">
                            <div className="swiper-wrapper">
                                ...
                                <SwiperSlide className="swiper-slide product-block">
                                    <div className="inner-box">
                                        <div className="image">
                                            <Link href="/shop-product-details"><img loading="lazy" decoding="async" src="/images/product/product-image2.png" alt="image"/></Link>
                                            <div className="star">
                                                <i className="fa-solid fa-star"></i>
                                                <i className="fa-solid fa-star"></i>
                                                <i className="fa-solid fa-star"></i>
