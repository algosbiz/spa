...
export default function Home2_Pricing() {
    return (
        <>
            ...
            <div className="row g-3">
                <div className="col-xl-6 image-column">
                    <div className="inner-column gsap__parallax-zoom">
                        <img loading="lazy" decoding="async" src="/images/pricing/pricing-image.jpg" alt="imag"/>
                    </div>
                </div>
                <div className="col-xl-6 content-column">
                    <div className="inner-column">
                        <div className="outer-shape">
                            <img loading="lazy" decoding="async" className="animation__arryUpDown" src="/images/shape/pricing-shape.png" alt="image"/>
                        </div>
                        ...
                        <div className="row g-3">
                            <div className="col-sm-6 pricing-block wow fadeInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
                                <div className="inner-box transparent">
                                    ...
                                    <Link prefetch={false} href="https://wa.me/6287863175144" target="_blank" rel="noopener noreferrer" className="btn-one-light mt-35">Book Now
