...
export default function Home2_News() {
    const swiperOptions = {
						...
						<div className="swiper-wrapper">
							<SwiperSlide className="swiper-slide blog-block">
								<div className="inner-box">
									<div className="image-box">
										<div className="image">
											<img loading="lazy" decoding="async" src="/images/blog/blog-image1.jpg" alt="imag"/>
										</div>
									</div>
							...
							<SwiperSlide className="swiper-slide blog-block">
								<div className="inner-box">
									<div className="image-box">
										<div className="image">
											<img loading="lazy" decoding="async" src="/images/blog/blog-image2.jpg" alt="imag"/>
										</div>
									</div>
									<div className="content-box">
										<h6 className="info"><span>Admin</span><span className="dot">Body, Treatment</span></h6>
							...
							<SwiperSlide className="swiper-slide blog-block">
								<div className="inner-box">
									<div className="image-box">
										<div className="image">
											<img loading="lazy" decoding="async" src="/images/blog/blog-image3.jpg" alt="imag"/>
										</div>
									</div>
									<div className="content-box">
										<h6 className="info"><span>Admin</span><span className="dot">Body, Treatment</span></h6>
