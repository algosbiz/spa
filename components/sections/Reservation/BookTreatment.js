...
const lotusIcon = (
    <svg className="brand-lotus-icon-svg" width="25" height="26" viewBox="0 0 25 26" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <>
            <section className="book-treatment-section about-section section__decoration-top section__decoration-bottom bg-sub pt-130 pb-130">
                ...
                <div className="shape2 wow slideInRight" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <img loading="lazy" decoding="async" className="sway_Y__animation" src="/images/shape/service-shape-right.png" alt="shape" />
                </div>
                        ...
                        <div className="col-lg-6 content-column">
                            <div className="inner-column wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms" style={{ margin: '0 auto' }}>
                                <div className="section-header">
                                    ...
                                    <p style={{ color: '#A78627', marginBottom: '30px' }}>
                                ...
                                <div className="list mt-25">
                                    <ul>
                                        {homeServiceItems.map((item, index) => (
                                            <li key={index} style={{ display: 'flex', gap: '15px', marginBottom: '20px', alignItems: 'flex-start' }}>
                                                <span style={{ minWidth: '25px', paddingTop: '3px' }}>{lotusIcon}</span>
                                                <div>
