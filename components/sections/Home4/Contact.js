...
export default function Home4_Contact() {
    ...
    // Add your backend or API integration here
                    ...
                    <div className="col-lg-6 image-column">
                        <div className="inner-column gsap__parallax-zoom">
                            <div className="image-box">
                                <img loading="lazy" decoding="async" src="/images/contact/contact-four-image.jpg" alt="image"/>
                            </div>
                        </div>
                    </div>
