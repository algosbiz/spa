...
export default function Home4_Pricing() {
    return (
        <>
        <section id="projects" className="package-section  pb-130">
            <div className="shape1 wow slideInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                <img loading="lazy" decoding="async" className="sway_Y__animationY" src="/images/shape/package-four-shape-left.png" alt="image"/>
            </div>
