    ...
    return (
        ...
        <section id="about" className="about-section-four pb-130">
            <div className="outer-box">
                <div className="shape">
                    <img loading="lazy" decoding="async" className="animation__arryLeftRight" src="/images/about/about-four-shape.png" alt="image"/>
                </div>
                <div className="row g-4">
                    <div className="col-lg-5 left-column">
                        <div className="inner-column mt-80">
                            ...
                            <div className="image"><img loading="lazy" decoding="async" src="/images/about/about-four-image1.jpg" alt="image"/></div>
                        </div>
                    </div>
                    <div className="col-lg-7 right-column">
                        <div className="inner-column">
                            <div className="image">
                                <img loading="lazy" decoding="async" src="/images/about/about-four-image2.jpg" alt="image"/>
                            </div>
