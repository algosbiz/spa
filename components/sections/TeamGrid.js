                ...
                {data.map((item, teammGrid) => (
                    <div key={teammGrid} className="col-lg-3 col-md-6 team-block mb-50">
                        <div className="inner-box">
                            <div className="image"><img loading="lazy" decoding="async" src={`/images/team/${item.img}`} alt="Image" /></div>
                            ...
                            <div className="shape"><img loading="lazy" decoding="async" src={`/images/team/${item.img1}`} alt="Image" /></div>
