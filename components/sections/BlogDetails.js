...
const BlogOne = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Simulate submission (replace with actual logic or API call)
                            ...
                            <div className="blog-details__left">
                                ...
                                <div className="blog-details__bottom">
                                    <p className="blog-details__tags">
                                        ...
                                        <span>Tags</span>
                                        <Link href="/news-details">Business</Link> <Link href="/news-details">Agency</Link>
                                    </p>
                                ...
                                <div className="comment-one">
                                    ...
                                    <div className="comment-one__single">
                                        <div className="comment-one__image">
                                            <img src="images/resource/testi-2.jpg" alt="Image" />
                                        </div>
                                    ...
                                    <div className="comment-one__single">
                                        <div className="comment-one__image">
                                            <img src="images/resource/testi-1.jpg" alt="Image" />
                                        </div>
                                        <div className="comment-one__content">
                                            <h3>Sarah Albert</h3>
                                            <p>Mauris non dignissim purus, ac commodo diam. Donec sit amet lacinia nulla. Aliquam quis purus in justo pulvinar tempor. Aliquam tellus nulla, sollicitudin at euismod.</p>
                                        ...
                                        <form id="contact_form" name="contact_form" onSubmit={handleSubmit}>
                                            ...
                                            <div className="mb-3">
                                                ...
                                                <span className="btn-title">
                                                    {submitting ? "Please wait..." : "Submit Comment"}
                                                </span>
                                                </button>
                                            </div>
                                            </form>
                            ...
                            <div className="sidebar">
                                ...
                                <div className="sidebar__single sidebar__tags">
                                    ...
                                    <div className="sidebar__tags-list">
                                        <Link href="#">Consulting</Link> <Link href="#">Agency</Link> <Link href="#">Business</Link> <Link href="#">Digital</Link> <Link href="#">Experience</Link> <Link href="#">Technology</Link>
                                    </div>
                                </div>
