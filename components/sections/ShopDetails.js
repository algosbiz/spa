          ...
          <div className="bxslider">
            <div className="slider-content">
              <Swiper
                ...
                <SwiperSlide>
                  <div className="image-box"><img loading="lazy" decoding="async" src="/images/resource/products/product-details.jpg" alt="Image"/></div>
                </SwiperSlide>
                <SwiperSlide>
                  <div className="image-box"><img loading="lazy" decoding="async" src="/images/resource/products/product-details2.jpg" alt="Image"/></div>
                </SwiperSlide>
                <SwiperSlide>
                  <div className="image-box"><img loading="lazy" decoding="async" src="/images/resource/products/product-details3.jpg" alt="Image"/></div>
                </SwiperSlide>
              </Swiper>
              <Swiper
                ...
                <SwiperSlide className="product-thumb wide-100">
                  <figure className="image">
                    <img loading="lazy" decoding="async" src="/images/resource/products/product-details.jpg" alt="Image"/>
                  </figure>
                </SwiperSlide>
                <SwiperSlide className="product-thumb wide-100">
                  <figure className="image">
                    <img loading="lazy" decoding="async" src="/images/resource/products/product-details2.jpg" alt="Image"/>
                  </figure>
                </SwiperSlide>
                <SwiperSlide className="product-thumb wide-100">
                  <figure className="image">
                    <img loading="lazy" decoding="async" src="/images/resource/products/product-details3.jpg" alt="Image"/>
                  </figure>
                </SwiperSlide>
              </Swiper>
            </div>
        ...
        <div className="col-lg-6 col-xl-6 product-info">
          ...
          <div className="product-details__quantity">
            <h3 className="product-details__quantity-title">Choose quantity</h3>
                <div className="quantity-box">
                    <button type="button" className="sub text-white" onClick={() => handleQuantityChange('item1', -1)}>
                      <i className="fa fa-minus"></i>
                    </button>
                    <input type="number" id="1" value={quantities.item1} readOnly />
                    <button type="button" className="add text-white" onClick={() => handleQuantityChange('item1', 1)}>
          ...
          <div className="product-details__buttons">
            <div className="product-details__buttons-1">
              <Link href="/shop-cart" className="btn-two"><span className="btn-title">Add to Cart</span></Link>
            </div>
            <div className="product-details__buttons-2">
              <Link href="/shop-product-details" className="btn-one"><span className="btn-title">Add to Wishlist</span></Link>
            </div>
          </div>
          ...
          <div className="product-details__social align-items-center">
            ...
            <ul className="social-icon-one product-share d-flex align-items-center">
              <li className="me-3"><Link href="#"><i className="fa fa-x"></i></Link></li>
              <li className="me-3"><Link href="#"><i className="fab fa-facebook-f"></i></Link></li>
              <li className="me-3"><Link href="#"><i className="fab fa-pinterest"></i></Link></li>
            ...
            <div className="customer-comment">
                <div className="row clearfix">
                    <div className="col-lg-6 col-md-6 col-sm-12 comment-column">
                        <div className="single-comment-box">
                            <div className="inner-box">
                                <figure className="comment-thumb"><img loading="lazy" decoding="async" src="/images/resource/testi-2.jpg" alt="Image" /></figure>
                                <div className="inner">
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-12 comment-column">
                        <div className="single-comment-box">
                            <div className="inner-box">
                                <figure className="comment-thumb"><img loading="lazy" decoding="async" src="/images/resource/testi-1.jpg" alt="Image" /></figure>
                                <div className="inner">
                                    <ul className="rating clearfix">
                                        <li><i className="fas fa-star"></i></li>
                                        <li><i className="fas fa-star"></i></li>
                ...
                <form id="contact_form" name="contact_form" onSubmit={handleSubmit}>
                  ...
                  <div className="col-lg-12 col-md-12 col-sm-12 column">
                    <div className="review-box clearfix mb-3">
                      <p>Your Review</p>
                      <ul className="rating clearfix" style={{ listStyle: "none", paddingLeft: 0 }}>
                        {[1, 2, 3, 4, 5].map((star) => (
                          <li
                            key={star}
                            onClick={() => handleRating(star)}
                            style={{ display: "inline", cursor: "pointer", color: star <= formData.rating ? "#f4c150" : "#ccc" }}
                          >
                  ...
                  <div className="mb-3">
                    <input name="form_botcheck" className="form-control" type="hidden" value={formData.form_botcheck} />
    ...
    <div className="container pt-0 pb-90">
      ...
      <div className="row">
        <div className="product-block col-lg-3 col-md-6">
          <div className="inner-box">
            <div className="image-box">
              <div className="image"><Link href="/shop-product-details"><img loading="lazy" decoding="async" src="/images/resource/product1-1.jpg" alt="Image"/></Link></div>
        ...
        <div className="product-block col-lg-3 col-md-6">
          <div className="inner-box">
            <div className="image-box">
              <div className="image"><Link href="/shop-product-details"><img loading="lazy" decoding="async" src="/images/resource/product1-2.jpg" alt="Image"/></Link></div>
              <div className="icon-box">
                <Link href="/shop-product-details" className="ui-btn"><i className="fa fa-heart"></i></Link>
                <Link href="/shop-cart" className="ui-btn"><i className="fa fa-shopping-cart"></i></Link>
              </div>
        ...
        <div className="product-block col-lg-3 col-md-6">
          <div className="inner-box">
            <div className="image-box">
              <div className="image"><Link href="/shop-product-details"><img loading="lazy" decoding="async" src="/images/resource/product1-3.jpg" alt="Image"/></Link></div>
              <div className="icon-box">
                <Link href="/shop-product-details" className="ui-btn"><i className="fa fa-heart"></i></Link>
                <Link href="/shop-cart" className="ui-btn"><i className="fa fa-shopping-cart"></i></Link>
              </div>
        ...
        <div className="product-block col-lg-3 col-md-6">
          <div className="inner-box">
            <div className="image-box">
              <div className="image"><Link href="/shop-product-details"><img loading="lazy" decoding="async" src="/images/resource/product1-4.jpg" alt="Image"/></Link></div>
              <div className="icon-box">
                <Link href="/shop-product-details" className="ui-btn"><i className="fa fa-heart"></i></Link>
                <Link href="/shop-cart" className="ui-btn"><i className="fa fa-shopping-cart"></i></Link>
              </div>
