...
// The same flower the header's "Book an Appointment" button carries. The
// lotus that used to sit here is the brand logo, and CSS swaps every
// svg.icon[viewBox="0 0 25 26"] for that logo image -- so this one is
// deliberately unclassed, to be drawn rather than replaced.
const flowerIcon = (
    <svg width="22" height="23" viewBox="0 0 25 26" fill="none" xmlns="http://www.w3.org/2000/svg"
        style={{ color: '#A78627', flex: '0 0 22px' }} aria-hidden="true">
                                ...
                                <ul style={{ padding: 0, listStyle: 'none' }}>
                                    {listItems.map((item, idx) => (
                                        <li key={idx} style={{ display: 'flex', gap: '18px', marginBottom: '25px', alignItems: 'flex-start' }}>
                                            <span style={{ minWidth: '22px', paddingTop: '4px', display: 'inline-flex' }}>{flowerIcon}</span>
                                            <div>
                                                <h5 style={{ 
                                                    marginBottom: '6px', 
                                                    fontWeight: '500', 
