    ...
    return (
        <>
            ...
            <div className="items-container row" ref={isotopeContainer}>
                ...
                <div className="product-block masonry-item small-column all cat-2 product lenses col-lg-4 col-md-6 col-sm-12">
                    <div className="inner-box">
                        <div className="image-box">
                            <div className="image">
                                <Link href="/shop-product-details">
                                    <img loading="lazy" decoding="async" src="/images/resource/product1-1.jpg" alt="Image" />
                                </Link>
                            </div>
                ...
                <div className="product-block masonry-item small-column all cat-1 cat-2 product lenses col-lg-4 col-md-6 col-sm-12">
                    <div className="inner-box">
                        <div className="image-box">
                            <div className="image">
                                <Link href="/shop-product-details">
                                    <img loading="lazy" decoding="async" src="/images/resource/product1-2.jpg" alt="Image" />
                                </Link>
                            </div>
                            <div className="icon-box">
                                <Link href="/shop-product-details" className="ui-btn">
                ...
                <div className="product-block masonry-item small-column all cat-1 cat-2 cat-4 product lenses col-lg-4 col-md-6 col-sm-12">
                    <div className="inner-box">
                        <div className="image-box">
                            <div className="image">
                                <Link href="/shop-product-details">
                                    <img loading="lazy" decoding="async" src="/images/resource/product1-3.jpg" alt="Image" />
                                </Link>
                            </div>
                            <div className="icon-box">
                                <Link href="/shop-product-details" className="ui-btn">
                ...
                <div className="product-block masonry-item small-column all cat-1 cat-3  product lenses col-lg-4 col-md-6 col-sm-12">
                    <div className="inner-box">
                        <div className="image-box">
                            <div className="image">
                                <Link href="/shop-product-details">
                                    <img loading="lazy" decoding="async" src="/images/resource/product1-4.jpg" alt="Image" />
                                </Link>
                            </div>
                            <div className="icon-box">
                                <Link href="/shop-product-details" className="ui-btn">
