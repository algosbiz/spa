...
export const homepageTreatments = [
  ...
  },
  {
    ...
    options: [priceOption("1 Hour", "IDR 199K"), priceOption("1.5 Hours", "IDR 339K"), priceOption("2 Hours", "IDR 439K")],
  },
  {
    id: "balinese-massage",
  ...
  },
  {
    ...
    options: [priceOption("1 Hour", "IDR 350K"), priceOption("1.5 Hours", "IDR 520K"), priceOption("2 Hours", "IDR 695K")],
  },
  {
  ...
  },
  {
    ...
    options: [priceOption("1 Hour", "IDR 250K"), priceOption("1.5 Hours", "IDR 380K"), priceOption("2 Hours", "IDR 495K")],
  },
  {
    ...
    benefits: ["Helps control excess oil", "Supports clearer-looking skin", "Calms and refreshes the face", "Maintains healthy hydration"],
    options: [priceOption("Facial Treatment", "IDR 196K")],
  },
  {
    ...
    benefits: ["Boosts natural glow", "Improves skin smoothness and elasticity", "Deeply moisturizes", "Revives overall skin vitality"],
    options: [priceOption("Facial Treatment", "IDR 269K")],
  },
  {
    id: "biokos-facial",
    name: "Biokos Facial",
  ...
  },
  {
    ...
    options: [priceOption("Arms", "IDR 159K"), priceOption("Under Arms", "IDR 99K"), priceOption("Back (starting from)", "IDR 139K"), priceOption("Full Back", "IDR 299K"), priceOption("Half Legs", "IDR 149K"), priceOption("Full Legs", "IDR 299K"), priceOption("Waxing Brazilian", "IDR 350K")],
  },
  {
