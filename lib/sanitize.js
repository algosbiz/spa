...
export function sanitizeHtml(html) {
    ...
    return sanitizeHtmlLib(html, {
        ...
        // Force safe rel on links that open a new tab. The third argument must
        // stay true: with false the new attributes *replace* the existing ones,
        // which silently strips href off every link in the post.
        transformTags: {
