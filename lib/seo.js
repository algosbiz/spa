...
/** Absolute URL for a file under public/, for sitemap and og:image use. */
export const assetUrl = (p) =>
    /^https?:\/\//i.test(p) ? p : `${SITE_URL}/${String(p).replace(/^\/+/, '')}`

/**
 * The one banner image per page that sitemap.xml lists in its <image:image>
 * block -- the same thing Yoast emitted on the live site, where each <url>
 * carried exactly one <image:loc> pointing at the page's featured image.
 *
 * These are the heroes the pages already render: treatment pages get
 * createTreatmentImageSet(folder).hero, the rest their <Banner image> or
 * <PageTitle backgroundImage> (privacy/terms/wellness share the PageTitle
 * default, mirroring how those three shared price-page-banner.webp on
 * WordPress). Guide articles are not here -- their cover_image lives in
 * Supabase and is read by pages/sitemap.xml.js.
 *
 * Two routes are absent because they have no single hero to point at, which
 * is also how the live sitemap listed them: "/" is a multi-image slider, and
 * "/reservation" is a booking form with no banner at all.
 */
export const PAGE_IMAGES = {
    "/contact": "/images/contact/contact-1.webp",
    "/guide": "/images/blog/blog-1.webp",
    "/massage-kuta": "/images/services/massagekuta/massagekuta-1.webp",
    "/outcall-home-service-massage": "/images/homepage/homepage-28.webp",
    "/privacy-policy": "/images/bg/page-title-bg.jpg",
    "/seminyak": "/images/pricelist/pricelist-1.webp",
    "/seminyak/anti-cellulite-massage": "/images/services/cellulitemassage/cellulitemassage-1.webp",
    "/seminyak/balinese-massage": "/images/services/balinesemassage/balinesemassage-1.webp",
    "/seminyak/body-scrub": "/images/services/bodyscrub/bodyscrub-1.webp",
    "/seminyak/coconut-oil-massage": "/images/services/coconutoilmassage/coconutoilmassage-1.webp",
    "/seminyak/couple-spa": "/images/services/couplemassage/couplemassage-1.webp",
    "/seminyak/creambath": "/images/services/creambath/creambath-1.webp",
    "/seminyak/day-spa": "/images/services/dayspaseminyak/dayspa-1.webp",
    "/seminyak/deep-tissue-massage": "/images/services/deeptissuemassage/deeptissuemassage-1.webp",
    "/seminyak/ear-wax-removal": "/images/services/earcandle/earcandle-1.webp",
    "/seminyak/facial": "/images/services/balimoonfacial/balimoonfacial-1.webp",
    "/seminyak/foot-massage": "/images/services/footmassage/footmassage-1.webp",
    "/seminyak/foot-reflexology": "/images/services/footreflexology/footreflexology-1.webp",
    "/seminyak/hair-braiding": "/images/services/hairbraiding/hairbraiding-1.webp",
    "/seminyak/head-massage": "/images/services/headmassage/headmassage-1.webp",
    "/seminyak/hot-stone-massage": "/images/services/hotstonemassage/hotstonemassage-1.webp",
    "/seminyak/lymphatic-drainage-massage": "/images/services/lymphaticmassage/lymphaticmassage-1.webp",
    "/seminyak/manicure-pedicure": "/images/services/manicurepedicure/manicurepedicure-1.webp",
    "/seminyak/nail-spa": "/images/services/nailart/nailart-1.webp",
    "/seminyak/shiatsu-massage": "/images/services/shiatsumassage/shiatsumassage-1.webp",
    "/seminyak/sport-massage": "/images/services/sportsmassage/sportsmassage-1.webp",
    "/seminyak/sunburn-massage": "/images/services/sunburntreatment/sunburntreatment-1.webp",
    "/seminyak/thai-massage": "/images/services/thaimassage/thaimassage-1.webp",
    "/seminyak/traditional-massage": "/images/services/traditionalmassage/traditionalmassage-1.webp",
    "/seminyak/waxing-salon": "/images/services/waxing/waxing-1.webp",
    "/terms-and-conditions": "/images/bg/page-title-bg.jpg",
    "/villa-hotel-massage": "/images/services/massagehotelvilla/massagehotelvilla-1.webp",
    "/wellness-in-bali": "/images/bg/page-title-bg.jpg",
}
