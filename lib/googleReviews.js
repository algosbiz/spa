...
// Places API returns a small, curated set of reviews. Rotate that set per page so
// treatment pages do not all open on the same review while keeping the order stable
// between renders and revalidations.
export function rotateReviews(reviews, seed = "") {
    ...
    const offset = hash % reviews.length;
