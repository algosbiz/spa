const listMenuImages = {
  ...
  "Couple Deep Tissue Massage": "/images/listmenu/coupledeeptissumassage.webp",
  "Couple Massage": "/images/listmenu/couplemassage.webp",
  "Couple Massage Balinese": "/images/listmenu/couplebalinesemassage.webp",
  "Couple Massage Package": "/images/listmenu/couplemassagepackage.webp",
  "Couple Traditional Massage": "/images/listmenu/coupletraditionalmassage.webp",
  "Couple Warm Candle Massage": "/images/listmenu/couplewarmcandle.webp",
  ...
  "Foot Scrub": "/images/listmenu/footscrub.webp",
...
const treatmentImageAliases = {
  ...
  // The pricelist, the homepage catalogue and the outcall page each word the
  // couple treatments differently, so every wording is mapped to one photo.
  "Couple Balinese Massage": "Couple Massage Balinese",
  // The homepage lists A-D as separate rows, so each follows the massage it is
  // built on rather than the shared package photo, which would make all four
  // rows look alike. The grouped rows below keep the package photo.
  "Couple Massage Package A": "Couple Massage Balinese",
  "Couple Massage Package B": "Couple Massage Balinese",
  "Couple Massage Package C": "Couple Warm Candle Massage",
  "Couple Massage Package D": "Couple Warm Candle Massage",
  "Couple Massage Packages": "Couple Massage Package",
  "Couple Massage Warm Candle": "Couple Warm Candle Massage",
  "Couple Packages": "Couple Massage Package",
  "Couple Warm Candle Oil Massages": "Couple Warm Candle Massage",
...
export function getListMenuImage(treatmentName, fallback) {
  ...
  const image = listMenuImages[imageName];
  if (image) {
    return image;
  }

  // Couple variants that have no photo of their own keep the shared one.
