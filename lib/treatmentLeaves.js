// 14a.png was a cannabis leaf -- unmistakable, and it sat as decoration on
// treatment pages for a Bali spa. It has been dropped from the rotation and
// deleted from the repo; 7a and 1a, which were not in use, take its place.
// 1a is served as 1a-v2 because images carry a 30-day Cache-Control here:
// flipping the file in place left every returning visitor on the old copy,
// and purging the CDN cannot reach a browser cache. A new name can.
